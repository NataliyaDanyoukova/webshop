                        ...
                        <div class="p-2 w-1/6">
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    id="country"
                                    name="country"
                                    class=" bg-gray-100 rounded border border-gray-300 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
